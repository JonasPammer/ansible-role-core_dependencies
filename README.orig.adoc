...
.DISCLAIMER
=====
This role is a fork of https://github.com/robertdebock/ansible-role-core_dependencies/releases/tag/2.1.9[robertdebock/ansible-role-core_dependencies v2.1.9 on GitHub (11 Feb, 2022)] (https://github.com/robertdebock/ansible-role-core_dependencies/compare/2.1.9...master[compare changes since here])
(Apache License 2.0, Copyright Robert de Bock (robert@meinit.nl)),
for now just with added code comments.
=====
